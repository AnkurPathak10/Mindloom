...
const routes = [{title: 'Features', href: '#features'},
...
const Header = () => {
  ...
  return (
    <header className='p-4 flex justify-center items-center'>
        <Link href='/' className='w-full gap-1 flex items-center justify-left'> 
            <Image src='/mindloom.png' alt='Mindloom logo' width={25} height={25}/>
            <span className='dark:text-white font-semibold'>Mindloom.</span>
        </Link>
